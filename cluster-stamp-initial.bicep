...
var policyAssignmentNameEnforceDefenderInCluster_var = guid(policyResourceIdEnforceDefenderInCluster, resourceGroup().name, clusterName_var)
...
resource pe_keyVaultName 'Microsoft.Network/privateEndpoints@2020-05-01' = {
  name: 'pe-${keyVaultName_var}'
  location: location
  properties: {
    subnet: {
...
resource pe_keyVaultName_default 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2020-05-01' = {
  parent: pe_keyVaultName
  name: 'default'
  location: location
  properties: {
    ...
    trustedRootCertificates: [
      {
        ...
        properties: {
          keyVaultSecretId: '${reference(keyVaultName_var).vaultUri}secrets/appgw-ingress-internal-aks-ingress-tls'
        }
      }
    ]
    ...
    sslCertificates: [
      {
        ...
        properties: {
          keyVaultSecretId: '${reference(keyVaultName_var).vaultUri}secrets/gateway-public-cert'
        }
      }
    ]
    probes: [
...
resource agwName_Microsoft_Insights_default 'Microsoft.Network/applicationGateways/providers/diagnosticSettings@2021-05-01-preview' = {
...
resource Microsoft_ContainerService_managedClusters_clusterName_acrPullRole 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = {
  scope: resourceId('Microsoft.ContainerRegistry/registries', defaultAcrName)
...
resource clusterName 'Microsoft.ContainerService/managedClusters@2021-11-01-preview' = {
...
resource clusterName_Microsoft_Insights_default 'Microsoft.ContainerService/managedClusters/providers/diagnosticSettings@2021-05-01-preview' = {
...
resource Microsoft_EventGrid_systemTopics_providers_diagnosticSettings_clusterName_Microsoft_Insights_default 'Microsoft.EventGrid/systemTopics/providers/diagnosticSettings@2021-05-01-preview' = {
  name: '${clusterName_var}/Microsoft.Insights/default'
  properties: {
    workspaceId: resourceId('Microsoft.OperationalInsights/workspaces', logAnalyticsWorkspaceName)
    logs: [
...
resource policyAssignmentNameAKSLinuxRestrictive 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameEnforceHttpsIngress 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameEnforceInternalLoadBalancers 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameRoRootFilesystem 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameEnforceResourceLimits 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameEnforceImageSource 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
...
resource policyAssignmentNameEnforceDefenderInCluster 'Microsoft.Authorization/policyAssignments@2020-09-01' = {
  name: policyAssignmentNameEnforceDefenderInCluster_var
  properties: {
    displayName: '[${clusterName_var}] ${reference(policyResourceIdEnforceDefenderInCluster, '2020-09-01').displayName}'
